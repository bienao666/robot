...
/*
cron "59 59 23 * * *" 
注意：我调用feverrun_my_scripts的js获取CK。如果你没有拉到库啥的。。。。就需要修改一下下面的文件。
/ql/scripts/feverrun_my_scripts/jdCookie.js
*/
...
let secretp = '',
    ...
    const jdCookieNode = $.isNode() ? require('/ql/scripts/feverrun_my_scripts/jdCookie.js') : '';
    if ($.isNode()) {
